...
import XiaocaseProviderLogo from '@renderer/assets/images/providers/xiaocase.png'
...
export const SYSTEM_PROVIDERS_CONFIG: Record<SystemProviderId, SystemProvider> = {
  'xiaocase-api': {
    ...
    type: 'new-api',
    apiKey: '',
    apiHost: 'https://api.xiaocaseai.com',
    anthropicApiHost: 'https://api.xiaocaseai.com',
    models: [],
    isSystem: true,
    enabled: true
  },
...
export const PROVIDER_LOGO_MAP: AtLeast<SystemProviderId, string> = {
  ...
  'xiaocase-api': XiaocaseProviderLogo
} as const
...
export const PROVIDER_URLS: Record<SystemProviderId, ProviderUrls> = {
  ...
  'xiaocase-api': {
    api: {
      url: 'https://api.xiaocaseai.com'
    },
    websites: {
      official: 'https://api.xiaocaseai.com',
      apiKey: 'https://api.xiaocaseai.com/console/token',
      docs: 'https://wiki.xiaocaseai.cn',
      models: 'https://api.xiaocaseai.com/pricing'
    }
  }
}
...
export const isNewApiProvider = (provider: Provider) => {
  return ['new-api', 'cherryin', 'xiaocase-api'].includes(provider.id) || provider.type === 'new-api'
}
